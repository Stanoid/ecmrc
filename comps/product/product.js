...
<span style={{color:"grey"}} 
      className={Styles.MAIN_FONT}> {`${CURRENCY} `} <span style={{fontWeight:"bold",color:"#1c1c1c"}} >{parseFloat(props.price)} </span></span>
</div>

<div style={{display:props.hasGroup.data==null?"none":"block"}} className='col-span-2' >
