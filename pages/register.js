...
<div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:10,padding:5,width:"100%"}}>
  <div style={{width:40,height:40,borderRadius:100,backgroundColor:type>=0?MAIN_STYLE.primary:"gray",display:"flex",justifyContent:"center",alignItems:"center"}} >
    <span style={{fontSize:15,color:"white"}}>1</span>
  </div>

  <div style={{width:40,height:40,borderRadius:100,backgroundColor:type>=1?MAIN_STYLE.primary:"gray",display:"flex",justifyContent:"center",alignItems:"center"}} >
    <span style={{fontSize:15,color:"white"}}>2</span>
  </div>

  <div style={{width:40,height:40,borderRadius:100,backgroundColor:type>=2?MAIN_STYLE.primary:"gray",display:"flex",justifyContent:"center",alignItems:"center"}} >
...
<div style={{width:"90%",marginTop:-28,height:6,alignSelf:"center",zIndex:-1,backgroundColor:"gray"}}>
  <div style={{backgroundColor:MAIN_STYLE.primary,width:type*50+"%",height:"100%"}}>
    ...
    <div style={{display:type==0?"block":"none",zIndex:1}} className=" px-10 py-2 rounded-xl w-screen  max-w-sm">
      <div className="space-y-4">
        <h5 className="text-center  font-semibold text-gray-600"> معلومات الحساب</h5>
      ...
      <button style={{backgroundColor:MAIN_STYLE.primary}} onClick={()=>{setType(1)}} className="mt-4 w-full font-semibold  text-white py-2 rounded-md text-lg tracking-wide">
    ...
    <div style={{display:type==1?"block":"none",zIndex:1}} className=" px-10 py-8 rounded-xl w-screen  max-w-sm">
      <div className="space-y-4">
        ...
        <div onClick={()=>{setType(0)}} style={{fontSize:15,textDecoration:"underline",cursor:"pointer",color:MAIN_STYLE.primary,textAlign:"left"}}>
          رجوع
...
{/*   
  ...
  <InterCell  addcat={addcat}  id={2} selected={selected} name={"cat"} /> */}
        ...
        <button style={{backgroundColor:MAIN_STYLE.primary}} onClick={()=>{setType(2)}} className="mt-4 w-full font-semibold  text-white py-2 rounded-md text-lg tracking-wide">
        <div style={{display:'flex',justifyContent:"center",alignItems:"center"}}>
